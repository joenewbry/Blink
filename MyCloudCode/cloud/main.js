  ...
  //   query.containedIn('user', request.object.get('recipientsArrayPFUser'));
  //   query.find({
  //     error: alert ('failed somehow in requst');
  //     success: function(results) {
  //       for (var pushPerson in results){
  //         Parse.Push.send({
  //           where: pushPerson, // set our installation query.
  //           data: {
  //             alert: 'new message recieved', //request.object.get("message"),
  //             badge: "Increment",
  //             p: "m", // PayLoad Type is Message
  //             fu: request.object.get('sender').id, //From User ID
  //            },
  //          });     
  //       }
  //     }
